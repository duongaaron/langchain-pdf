# GPT-4/3.5 & LangChain - Create a ChatGPT Chatbot for accessing a pdf of current heart cancer clinical trials to match patients

Use the new GPT-4/3.5 api to build a chatGPT chatbot for multiple Large PDF files.
